...
//				new GenericCaptchaEngine(new GimpyFactory[] { new GimpyFactory(new RandomWordGenerator("123456789ABCE"),
//						new ComposedWordToImage(
//								new RandomFontGenerator(20, 20, new Font[] { new Font("Arial", 20, 20) }),
//								new GradientBackgroundGenerator(90, 30,
//										new SingleColorGenerator(new Color(235, 255, 255)),
//										new SingleColorGenerator(new Color(255, 195, 230))),
